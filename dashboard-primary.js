        ...
        <div class="hub-section-body">
          <div class="hub-three-col">
            ...
            <div>
              ...
              <ul class="hub-list">${activity.slice(0,4).map(a=>hubRow({title:a.action||a.title||a.description||a.text||'Activity',sub:a.detail||a.description||a.notes||a.text||'',meta:a.date||a.timestamp||a.when||a.at||'',tone:'',page:'activity'})).join('')||'<li class="hub-empty">No recent activity.</li>'}</ul>
            </div>
          </div>
        </div>
      </section>
