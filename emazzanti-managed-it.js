(function(){
  ...
  const project={id:'PRJ-0012',name:'eMazzanti Managed IT Assessment & Support',scope:'Managed IT / Infrastructure',owner:'Pietro / Damiano / eMazzanti',priority:'High',status:'In Progress',due:'2026-09-30',progress:'10',nextAction:'Schedule technical deep-dive and onsite assessment; obtain written findings, support model and commercial proposal',description:"Evaluate eMazzanti as Il Bisonte NYC's structured managed IT partner for proactive monitoring, 24/7 support, WatchGuard management, Wi-Fi/network remediation, device maintenance and future U.S. store scalability.",objective:"Define a sustainable local IT support model that reduces dependence on Italy, gives the NYC store a reliable escalation path and clearly separates managed technical support from Il Bisonte's internal project/operations coordination.",stakeholders:"Damiano Ferraro, Pietro Forestieri, Nadege Konyn, Nirvan L. Ramoutar, Dylan E. D'Souza, Carl J. Mazzanti, Store Manager",deliverables:'Technical assessment; network/cabling review; WatchGuard audit; Wi-Fi/AP recommendations; device inventory; monitoring/patching proposal; 24/7 support/SLA model; prioritized remediation list; commercial proposal; scalable U.S. store standard',risks:'Cost sensitivity; unclear service scope/SLA; overlap with Italy IT responsibilities; managed service may exceed actual needs of a single small U.S. store; support model must remain proportionate to business size',dependencies:'eMazzanti technical assessment; access to store/network equipment; confirmation of Italy IT responsibilities; commercial terms and SLA',notes:'Meeting recap received Sep 7, 2026. Email describes managed-service capabilities and next steps but does not yet include pricing, final SLA, contract term or detailed commercial scope.',links:'',attachments:'Nadege meeting recap / Nirvan forward - Sep 7, 2026'};
  const tasks=[
