const CACHE='ib-ops-v0111-apps-script-refresh';
const SHELL=['/','/index.html','/styles.css','/notifications.css','/access-modal.css','/ui-enhancements.css','/layout-v04.css','/pass-vault.css','/auth.css','/roadmap.css','/project-workspace.css','/operations-control.css','/pm-worklog.css','/mobile-v010.css','/intuitive-layout.css','/dashboard-now.css?v=0104','/professional-icons.css','/i18n.css','/config.js','/runtime-stability.js?v=0104','/auth.js','/signup.js','/data-provider.js','/emazzanti-managed-it.js','/access-provider.js','/app.js','/startup-fast.js','/role-bootstrap.js','/workspace-cache.js','/notifications.js','/ui-enhancements.js','/pass-vault.js','/roadmap-phase-workspace-v2.js','/roadmap.js','/project-workspace.js','/operations-control.js','/pm-worklog.js','/intuitive-layout.js?v=0104','/dashboard-primary.js?v=0104','/professional-icons.js','/i18n.js','/manifest.webmanifest','/icon.svg'];
